        ...
        <div>
            ...
            <div className="grid absolute top-[300px] grid-cols-1 lg:grid-cols-2 items-center gap-4 justify-center">
                <div className="flex flex-col md:flex-row gap-3 lg:gap-4">
                    <img className="w-full md:w-[45%] mx-auto lg:w-[49%] h-[380px]" src="https://i.ibb.co/TP8tgwk/13.png" />
                    <img className="w-full md:w-[45%] mx-auto lg:w-[49%] h-[380px]" src="https://i.ibb.co/1KLhyxb/17.png" />
                </div>
                <div>
                    <img className="h-[380px] w-full" src="https://i.ibb.co/hM8CSSh/14.png" />
                </div>
                <div>
                    <img className="h-[380px] w-full" src="https://i.ibb.co/tJ5WDd4/amenities-5.png" />
                </div>
                <div className="flex flex-col md:flex-row gap-3 lg:gap-4">
                    <img className="w-full md:w-[45%] mx-auto lg:w-[49%] h-[380px]" src="https://i.ibb.co/C0tSHJm/15.png" />
                    <img className="w-full md:w-[45%] mx-auto lg:w-[49%] h-[380px]" src="https://i.ibb.co/z8z9dwg/16.png" />
                </div>
                <div className="flex flex-col md:flex-row gap-3 lg:gap-4">
                ...
                <div>
                    <img className="h-[380px] w-full" src="https://i.ibb.co/2WS3DZw/2.png" />
                </div>
                <div>
                    <img className="h-[380px] w-full" src="https://i.ibb.co/Z6xbq1g/7.png" />
                </div>
                <div className="flex flex-col md:flex-row gap-3 lg:gap-4">
