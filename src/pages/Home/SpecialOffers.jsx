    ...
    return (
        <div className="my-20 mx-auto max-w-[1200px]">
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0 justify-between">
                {/* card-1 */}
                <div className="mx-auto lg:mx-0 w-[280px] h-[360px] bg-blue-100 rounded-[28px] shadow-xl shadow-[#00346540]">
                ...
                {/* card-2 */}
                <div className=" mx-auto w-[280px] h-[360px] bg-blue-100 rounded-[28px] shadow-xl shadow-[#00346540]">
