    ...
    return (
        <div>
            ...
            <div className="mt-10 max-w-[1320px] mx-auto flex justify-between items-center">
                <div>
                    <div className="w-[600px]">
                        <h1 className="text-5xl font-extrabold">Exclusive <span className="text-cyan-400">Delicacies</span></h1>
                        <p className="mt-5 text-gray-500">Indulge in a culinary journey like no other at Ocean Side Hotel's renowned dining establishment, "Exclusive Delicacies." Our chefs artfully blend flavors from around the world, presenting a menu that reflects sophistication and innovation. Immerse yourself in an ambiance of refined elegance as you savor each dish meticulously crafted with premium, locally sourced ingredients. From delectable seafood creations to exquisitely plated desserts, every bite is a symphony of taste and texture. "Exclusive Delicacies" promises a dining experience that transcends the ordinary, inviting you to savor the extraordinary at the heart of Ocean Side Hotel.</p>
                    </div>
                </div>
            ...
            <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)} >
                <div className="my-32 flex justify-center gap-20">
                    <div className="text-cyan-500">
                        ...
                        <p className="text-2xl text-center font-extrabold">YEARS OF SERVICE</p>
                    </div>
                    <div className="text-cyan-500">
                        {
                            counterOn &&
                        ...
                        <p className="text-2xl text-center font-extrabold">SQ. METER AREA</p>
                    </div>
                    <div className="text-cyan-500">
                        {
                            counterOn &&
                        ...
                        <p className="text-2xl text-center font-extrabold">NICE ROOMS</p>
                    </div>
                    <div className="text-cyan-500">
                        {
                            counterOn &&
                        ...
                        <p className="text-2xl text-center font-extrabold">HAPPY VISITORS</p>
                    </div>
                </div>
            </ScrollTrigger>
            ...
            <div className="bg-blue-950 py-16">
                ...
                <div className="flex justify-center gap-24 mt-16">
                    <img className="w-[200px] h-[200px]" src="https://i.ibb.co/jhmBV5b/award2.png" />
                    <img className="w-[200px] h-[200px]" src="https://i.ibb.co/myVJPdT/award3.png" />
                    <img className="w-[230px] h-[200px]" src="https://i.ibb.co/D9drvTM/award1.png" />
                    <img className="w-[200px] h-[200px]" src="https://i.ibb.co/N31r6fX/award4.png" />
                </div>
            </div>
        </div>
    );
