    ...
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between p-5">
                ...
                <div>
                    <h1 className="text-purple-600 text-3xl font-bold mt-5">{title}</h1>
                    <p className="max-w-[700px] pr-5 mt-4 text-gray-500">{roomDetail}</p>
            ...
            <div  className="mb-32 max-w-[1200px] p-5 lg:p-0 mx-auto">
                <div className="lg:w-[1200px] md:h-[320px] bg-purple-100 mx-auto mt-20 rounded-[42px]">
